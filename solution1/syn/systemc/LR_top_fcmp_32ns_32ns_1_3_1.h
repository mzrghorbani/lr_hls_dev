...
// ==============================================================
#ifndef __LR_top_fcmp_32ns_32ns_1_3_1__HH__
#define __LR_top_fcmp_32ns_32ns_1_3_1__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LR_top_fcmp_32ns_32ns_1_3_1) {
    ...
    SC_CTOR(LR_top_fcmp_32ns_32ns_1_3_1):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
