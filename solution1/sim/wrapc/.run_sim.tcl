...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/eepgmmg1/Xilinx/Vivado/2019.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/eepgmmg1/Xilinx/Vivado/2019.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/eepgmmg1/Xilinx/Vivado/2019.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/eepgmmg1/Xilinx/Vivado/2019.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/eepgmmg1/Xilinx/Vivado/2019.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LR_top.autotvin.dat"
	set constFileTvOut       "LR_top.autotvout.dat"
	set constFileHdlTvIn     "LR_top.autohdltvin.dat"
	set constFileHdlTvOut    "LR_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
